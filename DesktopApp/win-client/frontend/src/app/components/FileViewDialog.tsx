...
export const FileViewDialog = React.memo<{
  ...
  const fileUpdate = useSWRMutation(
    ...
    },
    {
      ...
      onError: (error) => toast.error(t("fileView.saveFailed", { error: String(error) })),
    }
  );
          ...
          <div className="flex min-w-0 items-center gap-2">
            ...
            {isEditingMode && file === null ? (
              <Input
                ...
                placeholder={t("fileView.filenamePlaceholder")}
        ...
        <div className="min-h-0 flex-1 overflow-hidden">
          {isEditingMode ? (
            <Textarea
              ...
              placeholder={t("fileView.contentPlaceholder")}
