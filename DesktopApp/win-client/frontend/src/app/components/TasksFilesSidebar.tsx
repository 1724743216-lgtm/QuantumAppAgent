    ...
    <>
      {Object.keys(files).length === 0 ? (
        <div className="flex h-full items-center justify-center p-4 text-center">
          <p className="text-xs text-muted-foreground">{t("tasksFiles.noFiles")}</p>
        </div>
      ) : (
...
export const TasksFilesSidebar = React.memo<{
  ...
  const groupedLabels = {
    pending: t("tasksFiles.pending"),
    in_progress: t("tasksFiles.inProgress"),
    completed: t("tasksFiles.completed"),
  };
        ...
        <div className="flex min-h-0 flex-1 flex-col gap-2 overflow-hidden">
          <div className="flex items-center justify-between px-3 pb-1.5 pt-2">
            ...
            <button
              ...
              aria-label={t("tasksFiles.toggleTasks")}
            >
              <ChevronDown size={14} />
            </button>
          </div>
          ...
          <div className="flex items-center justify-between px-3 pb-1.5 pt-2">
            ...
            <button
              ...
              aria-label={t("tasksFiles.toggleFiles")}
            >
              <ChevronDown size={14} />
            </button>
          </div>
