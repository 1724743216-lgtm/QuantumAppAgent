      ...
      {showRejectionInput && !isEditing && (
        <div className="mb-4">
          <label className="mb-2 block text-xs font-medium text-foreground">
            {t("toolApproval.rejectionMessage")}
          </label>
          <Textarea
            value={rejectionMessage}
            onChange={(e) => setRejectionMessage(e.target.value)}
            placeholder={t("toolApproval.rejectionPlaceholder")}
            className="text-sm"
            rows={2}
            disabled={isLoading}
          />
          ...
          <>
            ...
            >
              <Check
                ...
                aria-hidden="true"
              />
              {isLoading ? t("toolApproval.saving") : t("toolApproval.saveApprove")}
            </Button>
          </>
        ) : showRejectionInput ? (
          <>
            ...
            <Button
              ...
              disabled={isLoading}
            >
              {isLoading ? t("toolApproval.rejecting") : t("toolApproval.confirmReject")}
            </Button>
          </>
        ) : (
          <>
            ...
            {allowedDecisions.includes("approve") && (
              ...
              >
                <Check
                  ...
                  aria-hidden="true"
                />
                {isLoading ? t("toolApproval.approving") : t("toolApproval.approve")}
              </Button>
            )}
          </>
        )}
