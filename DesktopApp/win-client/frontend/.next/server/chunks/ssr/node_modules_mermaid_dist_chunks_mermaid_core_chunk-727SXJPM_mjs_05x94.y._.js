...
.edgeLabel[data-look="neo"] {
  ...
  ${(0,b.getIconStyles)()}
`,"getStyles"),t=(0,i.__name)((a,b="TB")=>{if(!a.doc)return b;let c=b;for(let b of a.doc)"dir"===b.stmt&&(c=b.value);return c},"getDir"),u=(0,i.__name)(function(a,b){return b.db.getClasses()},"getClasses"),v=(0,i.__name)(async function(a,b,c,j){i.log.info("REF0:"),i.log.info("Drawing class diagram (v3)",b);let{securityLevel:k,state:l,layout:m}=(0,h.getConfig2)();j.db.setDiagramId(b);let n=j.db.getData(),o=(0,d.getDiagramElement)(b,k);n.type=j.type,n.layoutAlgorithm=(0,f.getRegisteredLayoutAlgorithm)(m),n.nodeSpacing=l?.nodeSpacing||50,n.rankSpacing=l?.rankSpacing||50,n.markers=["aggregation","extension","composition","dependency","lollipop"],n.diagramId=b,await (0,f.render)(n,o),g.utils_default.insertTitle(o,"classDiagramTitleText",l?.titleTopMargin??25,j.db.getDiagramTitle()),(0,e.setupViewPortForSVG)(o,8,"classDiagram",l?.useMaxWidth??!0)},"draw");a.s(["ClassDB",0,r,"classDiagram_default",0,l,"classRenderer_v3_unified_default",0,{getClasses:u,draw:v,getDir:t},"styles_default",0,s])}];

//# sourceMappingURL=node_modules_mermaid_dist_chunks_mermaid_core_chunk-727SXJPM_mjs_05x94.y._.js.map